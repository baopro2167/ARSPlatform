...
namespace ARSPlatform.REPO.Interfaces
{
    ...
    {
        Task<IEnumerable<ForumPost>> SearchAsync(string? search, string? category, string? sort);
        Task<PagedResult<ForumPost>> SearchPagedAsync(PaginationParams paginationParams, string? search, string? category, string? sort);
