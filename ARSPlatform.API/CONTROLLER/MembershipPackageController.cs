...
namespace ARSPlatform.API.CONTROLLER
{
    ...
    public class MembershipPackageController : ControllerBase
    {
        ...
        /// <returns>Danh sách gói thành viên có phân trang</returns>
        [HttpGet("paged")]
        public async Task<ActionResult<PagedResult<MembershipPackageResponse>>> GetPaged([FromQuery] PaginationParams paginationParams)
        {
