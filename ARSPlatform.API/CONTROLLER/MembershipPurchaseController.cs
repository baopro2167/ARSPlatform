...
namespace ARSPlatform.API.CONTROLLER
{
    ...
    public class MembershipPurchaseController : ControllerBase
    {
        ...
        /// <returns>Danh sách lịch sử mua gói thành viên có phân trang</returns>
        [HttpGet("paged")]
        public async Task<ActionResult<PagedResult<MembershipPurchaseResponse>>> GetPaged([FromQuery] PaginationParams paginationParams)
        {
