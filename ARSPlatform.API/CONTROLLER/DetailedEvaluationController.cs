...
namespace ARSPlatform.API.CONTROLLER
{
    ...
    public class DetailedEvaluationController : ControllerBase
    {
        ...
        public DetailedEvaluationController(IDetailedEvaluationRepository repository, IMapper mapper)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(int id, [FromBody] DetailedEvaluationUpdateRequest request)
        {
            var item = await _repository.GetByIdAsync(id);
            if (item == null) return NotFound();
