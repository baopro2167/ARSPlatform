...
namespace ARSPlatform.API.CONTROLLER
{
    ...
    public class MajorFieldController : ControllerBase
    {
        ...
        /// <returns>Danh sách lĩnh vực nghiên cứu lớn có phân trang</returns>
        [HttpGet("paged")]
        public async Task<ActionResult<PagedResult<MajorFieldResponse>>> GetPaged([FromQuery] PaginationParams paginationParams)
        {
