...
namespace ARSPlatform.MODELS.Migrations
{
    ...
    [Migration("20260915081605_AddTopicLearningMaterialsAndGroupJoinRequests")]
    partial class AddTopicLearningMaterialsAndGroupJoinRequests
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ARSPlatform.MODEL.Entities.AnnualFee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("UserRole", "BillingCycle", "Status")
                        .IsUnique()
                        .HasDatabaseName("UQ_AnnualFees_Active_Role_Cycle")
                        .HasFilter("[Status] = 1");

                    b.ToTable("AnnualFees", (string)null);
                });
            ...
            modelBuilder.Entity("ARSPlatform.MODEL.Entities.Medal", b =>
                {
                    ...
                    b.Property<string>("CriteriaMetric")
                        .IsRequired()
                        .HasMaxLength(100)
                        .IsUnicode(false)
                        .HasColumnType("varchar(100)");
                    ...
                    b.Property<string>("CriteriaUnit")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.Property<string>("MetricCode")
                        ...
                        .IsUnicode(false)
                        .HasColumnType("varchar(50)")
                        .HasDefaultValue("PROLIFIC_AUTHOR");
                    ...
                    b.ToTable("Papers", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_Papers_PaperType", "[PaperType] IN ('Journal', 'Conference')");
                        });
            ...
            modelBuilder.Entity("ARSPlatform.MODEL.Entities.ResearchGroupJoinRequest", b =>
                {
                    ...
                    b.HasIndex(new[] { "ApplicantUserId", "Status" }, "IX_ResearchGroupJoinRequests_ApplicantUserId_Status");

                    b.HasIndex(new[] { "ResearchGroupId", "Status" }, "IX_ResearchGroupJoinRequests_ResearchGroupId_Status");

                    b.ToTable("ResearchGroupJoinRequests", (string)null);
                });
            ...
            modelBuilder.Entity("ARSPlatform.MODEL.Entities.ResearchTopicLearningMaterial", b =>
                {
                    b.Property<int>("ResearchTopicLearningMaterialId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ResearchTopicLearningMaterialId"));
                    ...
                    b.HasKey("ResearchTopicLearningMaterialId");

                    b.HasIndex("LearningMaterialId");

                    b.HasIndex(new[] { "TopicId", "LearningMaterialId" }, "IX_ResearchTopicLearningMaterials_TopicId_LearningMaterialId")
                        .IsUnique();

                    b.ToTable("ResearchTopicLearningMaterials", (string)null);
                });
            ...
            modelBuilder.Entity("ARSPlatform.MODEL.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = 4,
                            CreatedAt = new DateTime(2026, 9, 15, 8, 16, 4, 900, DateTimeKind.Utc).AddTicks(9852),
                            Name = "Lecturer"
                        },
                        new
                        {
                            RoleId = 5,
                            CreatedAt = new DateTime(2026, 9, 15, 8, 16, 4, 900, DateTimeKind.Utc).AddTicks(9857),
            ...
            modelBuilder.Entity("ARSPlatform.MODEL.Entities.Seminar", b =>
                {
                    ...
                    b.Property<DateTime?>("AiFeedbackGeneratedAt")
                        .HasColumnType("datetime2(7)");
            ...
            modelBuilder.Entity("ARSPlatform.MODEL.Entities.SeminarParticipant", b =>
                {
                    ...
                    b.Property<DateTime?>("FeedbackUpdatedAt")
                        .HasColumnType("datetime2(7)");
            ...
            modelBuilder.Entity("ARSPlatform.MODEL.Entities.UserMedal", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasIndex(new[] { "UserId", "IsUnlocked" }, "IX_UserMedals_UserId_IsUnlocked");

                    b.HasIndex(new[] { "UserId", "MedalId" }, "UQ_UserMedals_UserId_MedalId")
                        .IsUnique();
            ...
            modelBuilder.Entity("ARSPlatform.MODEL.Entities.UserSubscription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("LatestTransactionId");
            ...
            modelBuilder.Entity("ARSPlatform.MODEL.Entities.ResearchGroupJoinRequest", b =>
                {
                    b.HasOne("ARSPlatform.MODEL.Entities.User", "ApplicantUser")
                        .WithMany("ResearchGroupJoinRequests")
                        .HasForeignKey("ApplicantUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_ResearchGroupJoinRequests_ApplicantUser");

                    b.HasOne("ARSPlatform.MODEL.Entities.User", "DecidedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("ARSPlatform.MODEL.Entities.ResearchTopicLearningMaterial", b =>
                {
                    b.HasOne("ARSPlatform.MODEL.Entities.LearningMaterial", "LearningMaterial")
                        .WithMany("ResearchTopicLearningMaterials")
            ...
            modelBuilder.Entity("ARSPlatform.MODEL.Entities.Transaction", b =>
                {
                    b.HasOne("ARSPlatform.MODEL.Entities.AnnualFee", "AnnualFee")
                        .WithMany("Transactions")
                        .HasForeignKey("AnnualFeeId")
                        .OnDelete(DeleteBehavior.SetNull)
            ...
            modelBuilder.Entity("ARSPlatform.MODEL.Entities.UserMedal", b =>
                {
                    b.HasOne("ARSPlatform.MODEL.Entities.Medal", "Medal")
                        .WithMany("UserMedals")
            ...
            modelBuilder.Entity("ARSPlatform.MODEL.Entities.UserSubscription", b =>
                {
                    b.HasOne("ARSPlatform.MODEL.Entities.Transaction", "LatestTransaction")
                        .WithMany()
                        .HasForeignKey("LatestTransactionId")
                        .OnDelete(DeleteBehavior.SetNull)
                    ...
                    b.Navigation("LatestTransaction");
            ...
            modelBuilder.Entity("ARSPlatform.MODEL.Entities.LearningMaterial", b =>
                {
                    b.Navigation("ResearchTopicLearningMaterials");
            ...
            modelBuilder.Entity("ARSPlatform.MODEL.Entities.User", b =>
                {
                    ...
                    b.Navigation("ResearchGroupJoinRequests");
